-- FICHEIRO: benchmarks_depois_indices_forcado_e_real.sql
...
END $$;-- Não é necessário nenhum SET. O enable_seqscan está no seu valor padrão (on).
    ...
    -- ---
    -- Invocação de todas as Queries com a etapa 'depois_c_seqscan'
    -- ---

    PERFORM run_benchmark(
        'SELECT d.nome, COUNT(f.id_fun) AS total_funcionarios ...',
        'Q01',
        'depois_c_seqscan'
    );
    
    PERFORM run_benchmark(
        'SELECT f.primeiro_nome || '' '' || f.ultimo_nome AS nome_completo, s.salario_bruto ...',
        'Q02',
        'depois_c_seqscan'
    );
    
    -- ... (Todas as outras queries Q03, Q04, Q07, Q08, Q09, Q10, Q11, Q12, Q14, Q15, Q16, Q19, Q20, Q21, Q22)
